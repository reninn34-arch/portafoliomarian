...
const { MIME, EXT_PERMITIDAS, nombreSeguro } = require('./comun');

const UPLOADS_DIR = path.join(__dirname, '..', 'public', 'uploads');

const enBlob = () => !!process.env.BLOB_READ_WRITE_TOKEN;
...
module.exports = { guardarBuffer, guardarMedio, listarMedios, borrarMedio, enBlob, UPLOADS_DIR };
